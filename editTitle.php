...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Please Edit the title of Survey Question</h2>
  <div align="center">
  
  <?php
$getUID = $_GET['titleId'];
$res=mysqli_query($conn, "SELECT * FROM surverytitle WHERE ID=".$getUID);
$titleRow=mysqli_fetch_array($res);
?>
   <form action="processEditTitle.php" method="post" enctype="multipart/form-data" onSubmit="alert('Successful edited!');">

			

	
		<div>
			<textarea name="Title"  rows="5" cols="90"><?php echo $titleRow['titledescp']; ?></textarea> 
		</div> 
<input type="hidden" size="70" name = "titleId" value = "<?php echo $_GET['titleId']; ?>" >
