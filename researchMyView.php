...
<div style = "background: rgba(255, 255, 255, 0.9);">
  ...
  <form action="process_researchMyView.php" method="post" enctype="multipart/form-data">
		...
		<p> <label><font color="purple"><b>*Title: </b></font></label>
			<input type="text" size="70" name="title" value = "<?php echo $researchRow['title'];?>" required  ;/>
	   </p>
		...
		<p>	<label><font color="purple"><b>*Contact Email: </b></font> </label> 
            <input type="email" name="contactEmail" size="70"  value = "<?php echo $researchRow['contactEmail'];?>" required  ;/>
		</p>
		
		<p>	<label><font color="purple"><b>Contact number: </b></font> </label> 
            <input type="text" name="contactNumber" size="70" value = "<?php echo $researchRow['contactNum'];?>" required ;/>
		</p>
		
		<p>	<label><font color="purple"><b>*Cooperation: </b></font> </label> 
            <input type="text" name="cooperation" size="70"  value = "<?php echo $researchRow['cooperation'];?>" required ;/>
		</p>
