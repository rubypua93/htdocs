...
<div style = "background: rgba(255, 255, 255, 0.9);">
 ...
 <p>  <label><font color="purple"><b>*Title: </b></font></label>
	   <input type="text" size="70" name="title"/>
		...
		<p class="formfield"> <label><font color="purple"><b>*Content:  </b></font> </label><textarea rows="10" cols="70" name="content"/></textarea> </p>
...
include_once 'DBConnect.php';
	...
	if(isset($_POST['action'])) {
		...
		if ($_POST["title"] == ""){
			echo "<script type='text/javascript'>alert('Action not sucessful. Please fill up the title.'); window.history.back();</script>";
		}
