...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">View All Surveys</h2>
  <div align="center">
...
$result = mysql_query("SELECT id,titledescp,status FROM surverytitle ORDER BY create_date DESC");
$number = 1;
while ($row = mysql_fetch_array($result, MYSQL_NUM)) {

$res=mysqli_query($conn, "select count(1)as total from (select studentanswer.userid from studentanswer left join surveryqa on studentanswer.quesstionid = surveryqa.id where surveryqa.title = ".$row['0']." group by studentanswer.userid ) as x;");
$adminRow=mysqli_fetch_array($res);
$TotalStudent = $adminRow['total'];


echo " 
			<tr><td width = '10%'>".$number."</td><td><a href = 'viewQuestion.php?titleId=".$row['0']."&name=".$row['1']."'> ".$row['1']."</a></td> ";
if($row['2'] == 'Y'){
echo			"<td>Activated</td><td><a href = 'processUpdateTitle.php?titleId=".$row['0']."&flag=Y'> deactivate</a></td> <td> <a href = 'processDeleteTitle.php?titleId=".$row['0']."' >delete</a></td> <td>".$TotalStudent."</td></tr>  ";
}			
else{
echo			"<td>Deactivated</td><td><a href = 'processUpdateTitle.php?titleId=".$row['0']."&flag=N'> activate</a>  </td> <td> <a href = 'processDeleteTitle.php?titleId=".$row['0']."'>delete</a></td> <td>".$TotalStudent."</td> </tr> ";
}
$number = $number + 1;
...
?>
   ...
   <p style="text-align: center;"><a class="btn btn-primary" href="createTitle.php"><font face="verdana"><b>Add Survey Title</b></a> </p>
