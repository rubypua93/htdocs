...
if(isset($_SESSION['admin']))
{
$result = mysql_query("SELECT jobID,title,company,created_by,create_date FROM job where created_by = '".$_SESSION['adminUserName']."' order by create_date desc");
}
else{
$result = mysql_query("SELECT jobID,title,company,created_by,create_date FROM job where created_by = '".$_SESSION['userName']."' order by create_date desc");
}
$number = 1;
while ($row = mysql_fetch_array($result, MYSQL_NUM)) {

echo "  <tr><td>".$number.".</td> 
			<td> <a href='viewMyJob.php?uid=".$row['0']."'> ".$row['1']." </a> </td><td>".$row['2']."</td><td>".$row['3']."</td> <td>".$row['4']."</td></tr>";
...
?>
   ...
   <p><a href="createjob.php"><font face="verdana"><b>Post a new job</b></a> </p>
