...
<div style = "background: rgba(255, 255, 255, 0.9);">
 ...
 <p>  <label><font color="purple"><b>Name: </b></font></label>
	...
	-->
		...
		{
			echo " <center>  <input class='btn btn-primary' name='action'  type='submit' value='Approve' onclick= 'return confirm(\"Are you sure want to approve this?\")' /> <font face='verdana'>   ";
			echo " <input class='btn btn-primary'  name='action' type='submit' value='Reject' onclick= 'return confirm(\"Are you sure want to reject this?\")' /> <font face='verdana'> </center>   ";
		}
		...
		else
		{
          ...
          <center>    <br> <p style="text-align: center;"><a class="btn btn-primary" href="approveFriend.php"><font face="verdana"><b>Back </b></a> </p> </center>
