...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Gallery</h2>
  <div align="center">


 <form action="processphotodelete.php" method="post" enctype="multipart/form-data">

<h1>Gallery</h1>
<h2>Please select the photo which ready to be deleted</h1>
...
$result = mysql_query("SELECT * FROM photo order by create_date desc");
$number = 0;
while ($row = mysql_fetch_array($result, MYSQL_NUM)) {
if($row['2'] == 'Y'){
echo "<tr> <td><input type='checkbox' name='imageID[".$number."]' value='". $row['0'] ."' /></td> <td> <center> <img height='100' width='100' src= '../photo/". $row['1'] . "'/> </center></td> <td>  <input type='hidden' name = 'imageName[".$number."]' value = '". $row['1'] . "' >  <input type='checkbox' name = 'status[".$number."]' value = 'Y' checked disabled>  </td> </tr>";
}
else{
echo "<tr> <td><input type='checkbox' name='imageID[".$number."]' value='". $row['0'] ."' /> </td> <td><center> <img height='100' width='100' src= '../photo/". $row['1'] . "'/> </center></td> <td>  <input type='hidden' name = 'imageName[".$number."]' value = '". $row['1'] . "' >  <input type='checkbox' name = 'status[".$number."]' value = 'Y' disabled > </td> </tr>";
...
<br>
 <input type="submit" value="Delete" onclick="return confirm('Are you sure want to delete this?')"/> </p>
 <p style="text-align: center;"><a class="btn btn-primary" href="photoslideshow.php"><font face="verdana">Back to gallery</font></a>
