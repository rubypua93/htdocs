...
<div style = "background: rgba(255, 255, 255, 0.9);">
  ...
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;"></h2>
    <h3 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;"><?php echo $name ?></h3>
  <div align="center">
...
echo " <table style = 'width:90%' border = '1' align = 'center'> 
			<tr><td colspan='2'><a href = 'updateQuestion.php?titleid=".$_GET['titleId']."&uid=".$row['9']."&name=".$row['0']."'>Q".$number.". ".$row['0']."</a></td> </tr>
			<tr><td colspan='2'> <a href = 'processDeleteQuestion.php?QuestionId=".$row['9']."&titleid=".$_GET['titleId']."' >Click to Delete Question</a></td></tr>
			<tr>
			<td width = '50%'>A. ".$row['1']." </td> <td width = '50%'>B. ".$row['2']."</td>
			</tr>
			<tr>
			<td width = '50%'>C. ".$row['3']."</td> <td width = '50%'>D. ".$row['4']."</td> 
			</tr> 
			<tr>
			<td width = '50%'>E. ".$row['5']."</td> <td width = '50%'>F. ".$row['6']."</td> 
			</tr> 
			<tr>
			<td width = '50%'>G. ".$row['7']."</td> <td width = '50%'>H. ".$row['8']."</td> 
			</tr> 
			</table> <br>";
...
?>
    ...
    <p style="text-align: center;"><a class="btn btn-primary" href=" editTitle.php?titleId=<?php echo $_GET['titleId'] ?>"><font face="verdana"><b>Edit Title</b></a> </p>
  <p style="text-align: center;"><a class="btn btn-primary" href=" uploadQuestion.php?titleId=<?php echo $_GET['titleId'] ?>"><font face="verdana"><b>Add Question</b></a> </p>
