...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">View all Event Manager</h2>
...
$result = mysql_query("SELECT eventmanagerID,name,email,create_date FROM eventmanager order by create_date desc");
$number = 1;
while ($row = mysql_fetch_array($result, MYSQL_NUM)) {

echo "  <tr><td>".$number.".</td> 
			<td> <a href='eventmanagerlist.php?uid=".$row['0']."'> ".$row['1']." </a> </td> <td>".$row['2']."</td> <td>".$row['3']."</td>  </tr>";
...
<br>
   <p style="text-align: center;"><a class="btn btn-primary" href="deleteEventManager.php"><font face="verdana"><b>Delete event manager</b></a> </p>
<p style="text-align: center;"><a class="btn btn-primary" href="assignEM.php"><font face="verdana"><b>Create event manager</b></a> </p>
<br>
</div>
        </div>
      </div>
