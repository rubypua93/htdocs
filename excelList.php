...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">View Excel File Records </h2>
...
$result = mysql_query("SELECT userID,fullName,email,userName,programme,major,graduateYear,matricNum,phoneNum,address,occupation FROM user where status=2 order by userID desc ");
$number = 1;
...
<br>
 <p style="text-align: center;"> <input type="submit" value="Send Login information via Email" onclick="return confirm('Are you sure want to send login information to alumni's email address?')"/> </p>
