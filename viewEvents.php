...
$result = mysql_query("SELECT eventsID,title,start_date,end_date,create_date,created_by,eventsID FROM events order by create_date desc");
$number = 1;
while ($row = mysql_fetch_array($result, MYSQL_NUM)) {
	
$result1 = mysql_query("SELECT a.eventmanagerID, a.name FROM eventmanager a inner join event_eventmanager b on a.eventmanagerID = b.eventmanagerID where b.eventID = ".$row['6']."");
$num_rows = mysql_num_rows($result1);
echo "  <tr><td>".$number.".</td> 
			<td> <a href='adminViewPerEvents.php?uid=".$row['0']."'> ".$row['1']." </a> </td> <td>".$row['2']."</td> <td>".$row['3']."</td> <td>".$row['4']."</td> <td>".$row['5']."</td> <td>" ;
...
<br>
   <p style="text-align: center;"><a class="btn btn-primary" href="createevents.php"><font face="verdana"><b>Create event</b></a> </p>
  <p style="text-align: center;"><a class="btn btn-primary" href="deleteEvent.php"><font face="verdana"><b>Delete event</b></a> </p>
<br>
</div>
        </div>
      </div>
