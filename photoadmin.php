...
<div style = "background: rgba(255, 255, 255, 0.9);">
 ...
 <input type="file" name="photo" required>
  ...
  <p style="text-align: center;"><a class="btn btn-primary" href="photoslideshow.php"><font face="verdana"><b>Proceed to Gallery</b></a> 
   <p style="text-align: center;"><a class="btn btn-primary" href="photoslideshowpreview.php"><font face="verdana"><b>Proceed to Slideshow</b></a> </p>
