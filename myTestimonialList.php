...
{ 
	...
	if ($search == "approved"){
		...
		$result = mysqli_query($conn,"SELECT testimonial_ID, title,author,date FROM testimonial WHERE status = '0' AND createUserID=  '".$_SESSION['user']."'  order by date desc");
		$number = 1;
		...
		$result = mysqli_query($conn,"SELECT testimonial_ID, title,author,date FROM testimonial WHERE status = '1' AND createUserID=  '".$_SESSION['user']."'  order by date desc");
		$number = 1;
		...
		$result = mysqli_query($conn,"SELECT testimonial_ID, title,author,date FROM testimonial WHERE status = '2' AND createUserID=  '".$_SESSION['user']."'  order by date desc");
		$number = 1;
...
<br/>    
  ...
  -->
  <p style='text-align: center;'><a class='btn btn-primary' href="createTestimonial1.php"><font face="verdana"><b>Create Testimonial</b></a> </p>
<br/>
