...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">My Research Collaboration Title List</h2>
  <div align="center">
...
$result = mysqli_query($conn,"SELECT researchID, title,author,date FROM researchcollaboration WHERE admin_ind ='N' AND createUserID=  '".$_SESSION['user']."'  order by date desc");
$number = 1;
