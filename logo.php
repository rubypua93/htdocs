...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Please insert the logo you want to display</h2>
  <div align="center">
   <form action="processlogo.php" method="post" enctype="multipart/form-data" onSubmit="alert('Logo Successful changed!');">
