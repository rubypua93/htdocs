...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Please fill in your Questions and Choices of Answer</h2>
  <div align="center">
   <form action="processUploadQuestion.php" method="post" enctype="multipart/form-data" onSubmit="alert('Successful upload question!');">

			

		<label class="description" for="element_1">Question </label>
		<div>
			<textarea name="Question"  rows="5" cols="90" required/></textarea> 
		</div> 

		<label class="description" for="element_2">Answer A </label>
		<div>
			<input name="answerA" type="text" maxlength="255" size = "90" value="" required/> 
		</div> 

		<label class="description" for="element_3">Answer B </label>
		<div>
			<input name="answerB" type="text" maxlength="255" size = "90" value=""required/> 
		</div> 

		<label class="description" for="element_5">Answer C </label>
		<div>
			<input name="answerC" type="text" maxlength="255" size = "90" value=""/> 
		</div> 

		<label class="description" for="element_4">Answer D </label>
		<div>
			<input name="answerD" type="text" maxlength="255" size = "90" value=""/> 
		</div> 
				<label class="description" for="element_4">Answer E </label>
		<div>
			<input name="answerE" type="text" maxlength="255" size = "90" value=""/> 
		</div> 
				<label class="description" for="element_4">Answer F </label>
		<div>
			<input name="answerF" type="text" maxlength="255" size = "90" value=""/> 
		</div> 
				<label class="description" for="element_4">Answer G </label>
		<div>
			<input name="answerG" type="text" maxlength="255" size = "90" value=""/> 
		</div> 
				<label class="description" for="element_4">Answer H </label>
		<div>
			<input name="answerH" type="text" maxlength="255" size = "90" value=""/> 
		</div> 

			    <input type="hidden" name="titleId" value="<?php echo $_GET['titleId'];?>" />
			    </br>
...
<br>
   ...
   <p style="text-align: center;"><a class="btn btn-primary" href="viewQuestion.php?titleId=<?php echo $_GET['titleId'];?>"><font face="verdana"><b>Check Question</b></a> </p>
