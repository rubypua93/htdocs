...
?>
  ...
  <form action="process_editnews.php" method="post" enctype="multipart/form-data" onSubmit="alert('Successful edited!');">
</head>
<body>
<div id="header">
 <div id="left">
  ...
  <p><label>*Title: </label><input type="text" name="title" size="50" value="<?php echo $newsRow['title']; ?>" required/></p>
    ...
    if(file_exists( __DIR__."/picture/".$newsRow['picture']."") and ($newsRow['picture'] != ""))
      echo "<img height='500' width='500' src= '../picture/". $newsRow['picture'] . "'/>" ;
    else
    ...
    <label>Please upload the photo you want to update</label>
                      </br>
    ...
    <p><a href="viewNews.php?uid=<?php echo $_GET['uid'] ?>"><font face="verdana">Back </a> </p>
  </div>
</div>
        </div>
      </div>
