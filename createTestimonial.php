...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Post a news or annoucements.</h2>
  <div align="center">
 <form action="process_testimonial.php" method="post" enctype="multipart/form-data" onSubmit="alert('Successful posted!');">
...
<textarea name="description" required/></textarea>
							...
							<p style="text-align: center;"><input class="btn btn-primary" type="submit" name="save" /> <font face="verdana"></br>
              <br/><p><a href="news.php"><font face="verdana">Back to testimonial list </a> </p>
              </center>
                        </form>    
</div>
</div>
