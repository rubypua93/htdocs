...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Assign Event Managers</h2>
  <div align="center">
 <form action="process_assignEM.php" method="post" enctype="multipart/form-data" onSubmit="alert('Successful added!');">
<br>
 ...
 <p>
               <label><font color="purple"><b>Name:   </b></font></label>             
							...
							<br>
							<br>
							  <p style="text-align: center;"><a class="btn btn-primary" href="eventmanagerlist.php"><font face="verdana"><b>View event manager list</b></a> </p>
