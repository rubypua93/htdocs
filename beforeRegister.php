        ...
        <script type="text/javascript">
			...
			//	if (pictureURL == "undefined"){
               ...
               // document.write(JSON.stringify(profiles));
				 ...
				 window.location.href = "registerLinkedIn.php?username=" + firstName + "&fullname=" + firstName +" "+lastName + "&pictureURL=" + pictureURL +"&position=" + position; 
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" style="background-image: url(images/background.jpg);">
				...
				<form id="form1" runat="server">
					...
					<!--<a href="indexLinkedInNew.php">
					<img src="images/LargeLinkedIn.png" alt="LinkedIn"> </a>
					--></td>
					</tr>
					
					<tr>
					<td><a class="btn btn-primary" href="register.php"><font face="verdana">Create Account</td>
					</tr>
