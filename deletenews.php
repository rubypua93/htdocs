...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Delete news or annoucements </h2>
  <form action="processnewsdelete.php" method="post" enctype="multipart/form-data">
...
echo "  <tr>
    <td><input type='checkbox' name='newsID[".$number."]' value='". $row['0'] ."' /></td>
    <td>  ".$row['1']."  </td> 
    <td>".$row['2']."</td>
    </tr>";
...
?>
 ...
 <br>
 <p style="text-align: center;"><a class="btn btn-primary" href="news.php"><font face="verdana">Back to news list</a> </p>
