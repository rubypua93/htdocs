...
<div style = "background: rgba(255, 255, 255, 0.9);">
  ...
  <div align="center">
   ...
   <form action="processphotostatus.php" method="post" enctype="multipart/form-data">

<h4>Please select the photo which ready to display in slideshow</h4>
...
if($row['2'] == 'Y'){
echo "<tr> <td> <img height='100' width='100' src= '../photo/". $row['1'] . "'/> </td> <td>  <input type='hidden' name = 'status[".$number."]' value = 'N' >  <input type='checkbox' name = 'status[".$number."]' value = 'Y' checked> <input type='hidden' name='imageID[".$number."]' value='". $row['0'] ."' /> </td> </tr>";
}
else{
echo "<tr> <td> <img height='100' width='100' src= '../photo/". $row['1'] . "'/> </td> <td>  <input type='hidden' name = 'status[".$number."]' value = 'N' >  <input type='checkbox' name = 'status[".$number."]' value = 'Y' > <input type='hidden' name='imageID[".$number."]' value='". $row['0'] ."' /> </td> </tr>";
...
?>
 ...
 <p style="text-align: center;"><a class="btn btn-primary"  href="photo_delete.php"><font face="verdana">Proceed to Delete Page</font></a></p>
<p style="text-align: center;"><a class="btn btn-primary"  <a href="photoadmin.php"><font face="verdana">Back to upload photo</font></a>
