...
$email = mysqli_real_escape_string($conn, $_POST['email']);
 ...
 $res=mysqli_query($conn, "SELECT * FROM eventmanager WHERE email='$email'");
 $row=mysqli_fetch_array($res);
 if($row['password']==($upass))
 {
  $_SESSION['eventmanager'] = $row['eventmanagerID'];
    $_SESSION['eventmanagerName'] = $row['name'];
...
<head>
  ...
  <title>Login as event manager</title>
...
<td><p><font face="verdana"><a href="loginadmin.php">Log in as admin</a></font></p>
<p><font face="verdana"><a href="index.php">Log in as alumni</a></font></p></td>
