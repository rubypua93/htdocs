...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Delete Events </h2>
   <form action="processeventdelete.php" method="post" enctype="multipart/form-data">
...
echo "  <tr><td><input type='checkbox' name='eventsID[".$number."]' value='". $row['0'] ."' /></td>
			<td> ".$row['1']."  </td>  
			<td>".$row['2']."</td> 
			<td>".$row['3']."</td> 
			<td>".$row['4']."</td>
...
?>
 ...
 <br>
 <p style="text-align: center;"><a class="btn btn-primary" href="viewEvents.php"><font face="verdana">Back to Event list</a> </p>
