...
<br>
<br>
<p style="text-align: center;"><a class="btn btn-primary" href="editNews.php?uid=<?php echo $_GET['uid'] ?>"><font face="verdana">Update </a> </p>
  <p style="text-align: center;"><a class="btn btn-primary"  href="deleteNewsPerOne.php?uid=<?php echo $_GET['uid'] ?>" onclick="return confirm('Are you sure want to delete this?')"><font face="verdana">Delete </a> </p>
  <p><a href="news.php"><font face="verdana">Back </a> </p>
