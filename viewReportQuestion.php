...
echo " <table style = 'width:90%' border = '1' align = 'center'> 
			...
			<tr><td width = '50%'>A. ".$row['1']." </td> <td width = '50%'>B. ".$row['2']."</td></tr>
			<tr><td width = '50%'>C. ".$row['3']."</td> <td width = '50%'>D. ".$row['4']."</td> </tr> 
			<td width = '50%'>E. ".$row['5']."</td> <td width = '50%'>F. ".$row['6']."</td>  </tr> 
			<td width = '50%'>G. ".$row['7']."</td> <td width = '50%'>H. ".$row['8']."</td> </tr> </tr> </table> 
			<a href = 'viewChart.php?questionId=".$row['9']."&titleId=". $titleId ."' style = 'text-align: right;'> <font face='Times New Roman' size='4' color='red'><u>View Report for Q.".$number."</u></font></a> 
			<br>";
...
?>
  ...
  <br/>
<br/>
 <p style="text-align: center;"><a class="btn btn-primary" href="viewReportQuestionWithChart.php?titleId=<?php echo $titleId; ?>"><font face="verdana"><b>View Full Report</b></a> </p>
    <p style="text-align: center;"><a class="btn btn-primary" href=" report.php"><font face="verdana"><b>Back</b></a> </p>
</div>
</div>
        </div>
      </div>
