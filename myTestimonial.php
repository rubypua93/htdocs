...
<div style = "background: rgba(255, 255, 255, 0.9);">
  ...
  <div align="left">
   ...
   <form action="process_editTestimonial.php" method="post" enctype="multipart/form-data">
 ...
 <p>  <label><font color="purple"><b>*Title: </b></font></label>
	   <input type="text" size="70" name="title"  value = "<?php echo $testimonialRow['title'];?>"/>
	   </p>
		
		<p class="formfield"> <label><font color="purple"><b>*Content:  </b></font> </label><textarea rows="10" cols="70" name="content"/><?php echo $testimonialRow['content'];?></textarea> </p>
