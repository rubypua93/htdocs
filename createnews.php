...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Post a News or an Annoucements</h2>
  <div align="center">
 <form action="process_news.php" method="post" enctype="multipart/form-data" onSubmit="alert('Successful posted!');">
              ...
              <p>
                            <label><font color="purple">Upload picture:</font></label> 
              ...
              <br/><p><a href="news.php"><font face="verdana">Back to news list </a> </p>
              </center>
                        </form>    
</div>
</div>
