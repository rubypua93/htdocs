...
echo "  <tr><td>".$number.".</td> 
      <td> <a href='alumniViewPerNews.php?uid=".$row['0']."' style='color: #93291b;''> ".$row['1']." </a> </td> <td>".$row['2']."</td></tr>";
...
<br>
    <p style="text-align: center;"><a class="btn btn-primary" href="alumni.php"><font face="verdana"><b>Back</b></a> 
<br>
<br>
