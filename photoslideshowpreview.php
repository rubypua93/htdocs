...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Photo Slideshow</h2>
  <div align="center">
...
echo "<img class='mySlides'  height='400' width='600' src= '../photo/". $row['1'] . "'/>";
...
?>
 ...
 <p><a href="photoslideshow.php"><font face="verdana">Back to gallery</a> </p><p></p>
   <a href="photoadmin.php"><font face="verdana">Back to upload photo </font></a>
</div>
</div>
        </div>
      </div>
